...
import com.mercari.presenter.ProductMenPresenter
...
class ProductManFragment : ProductBaseFragment() {
    ...
    private lateinit var manModels : List<ProductModel>
    var manPrenster = ProductMenPresenter()
    val COLUMN = 2
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        manPrenster.attachView(mMenView)

        initData()
    }

    private fun initView() {
        var adapter = ProductAdapter(getActivity() as Context, manModels)
    ...
    var mMenView = object : ProductMenView{
